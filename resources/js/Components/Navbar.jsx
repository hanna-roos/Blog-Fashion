        ...
        <nav className="bg-[#141E7E] ">
            <div className="flex items-center space-x-8 py-3 px-4 max-w-screen-xl mx-auto md:px-8">
                ...
                <div className="flex-1 flex items-center justify-between">
                    <div
                        className={`bg-[#141E7E] absolute z-20 w-full top-16 left-0 p-4 border-b lg:static lg:block lg:border-none ${
                            menuState ? "" : "hidden"
                        }`}
                    >
                    ...
                    <div className="flex-1 flex items-center justify-end space-x-2 sm:space-x-6">
                        <form className="flex items-center space-x-2 rounded-md p-2">
                            ...
                            <input
                                className="w-24 sm:w-64  px-2 rounded-lg border border-white-300/20 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                                type="text"
                                placeholder="Search"
                            />
                        </form>
